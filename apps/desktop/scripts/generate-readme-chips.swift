...
//
// The design is specified in design/README Header.dc.html at the repo root. That artboard and
...
//
// Sibling projects (PwrAgent, PwrSnap) can adopt this file by editing `brand`
// and `chips` only. Nothing below those two declarations is PwrGit-specific.
...
let brand = Brand(
  ...
  accentTop: NSColor(deviceRed: 255 / 255.0, green: 162 / 255.0, blue: 77 / 255.0, alpha: 1),
