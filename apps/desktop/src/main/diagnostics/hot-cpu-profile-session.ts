// Ported from PwrAgnt (diagnostics/hot-cpu-profile-session.ts): one directory
// per armed capture holding a manifest, cpu samples/events ndjson, and any
// .cpuprofile / .heapsnapshot artifacts.
